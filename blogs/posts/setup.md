...
- Earpiece/Headphone: Some wired earphone I got at Walmart
...
| HandHeld | Cube |
|----------|------|
| ![Handheld](./blog-images/handheld.png) | ![Cube](./blog-images/cube.JPG) |

- Rubix Cube (3 x 3). Check out some [OLL's and PLL's](http://rubiksplace.com/speedcubing/OLL-algorithms/)
- PS4
- Grass (yeah!! real grass, turn off your screen and touch **mother earth**)
...
- Notes: Apple Notes
- Pen and Paper (cheap as hell, get them at the dollar store)
...
| Retro-Pie | Display |
|-----------|---------|
| ![Retro](./blog-images/retro.jpg) | ![Display](./blog-images/pie.jpg) |

[Watchy](https://watchy.sqfmi.com/)

| E-ink | Menu |
|-------|------|
| ![Watchy](./blog-images/w.JPG) | ![Menu](./blog-images/watchy.jpg) |
